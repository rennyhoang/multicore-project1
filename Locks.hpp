...
class PetersonLock : public LockStrategy<PetersonLock, 2> {
 private:
...
class GPLock : public LockStrategy<GPLock<N>, N> {
 private:
...
template <std::size_t N>
class FilterBBLock : public LockStrategy<FilterBBLock<N>, N> {
 private:
...
template <std::size_t N>
class TournamentTreeLock : public LockStrategy<TournamentTreeLock<N>, N> {
 private:
...
template <std::size_t N>
class BakeryLock : public LockStrategy<BakeryLock<N>, N> {
 private:
  std::atomic<bool> flag[N]{};
